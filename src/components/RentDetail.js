...
const RentDetail = ({info}) => {
    ...
    return (
        <div
            className='shadow shadow-lg border-2 border-gray-500 hover:border-gray-800 duration-300 bg-yellow-200 hover:bg-yellow-300 w-48 h-auto rounded m-auto mt-4 p-4 top-0 '>
            ...
            <h1>時間：{info.date}</h1>
            {!loadMore && <button
                className='z-0 shadow ring-2 ring-white hover:bg-yellow-700 hover:ring-indigo-300 transform hover:scale-110 duration-300 bg-yellow-500 w-auto h-auto p-1 rounded mt-1 text-white '
            ...
            <>
                ...
                <button
                    className='z-0 shadow ring-2 ring-indigo-300 hover:bg-yellow-700 transform hover:scale-110 duration-300 bg-yellow-500 w-auto h-auto p-1 rounded mt-1 text-white'

...
const Bar = ({editing, setEditing, setRentalInfo, data}) => {
    ...
    return (
        <div className='w-full h-auto bg-yellow-300 p-2 flex justify-between dark:bg-black'>
            ...
            <button onClick={clickHandler} className='shadow transform hover:scale-110 duration-300 p-2 ring-2 ring-indigo-300 rounded bg-white w-auto h-auto'>新增</button>
        </div>
    );
};

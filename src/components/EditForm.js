...
const EditForm = ({setEditingForm, nowEdit, editingForm, setLoading, userInfo, updateRef}) => {
    ...
    const submitHandler = (e) => {
        ...
        const updates = {};
        updates['/information/' + nowEdit.key] = data;
    ...
    return (
        <div className='w-full h-screen bg-gray-700 bg-opacity-40 fixed flex justify-center items-center p-2 z-10'>
            <form className='flex flex-col dark:bg-black bg-yellow-300 p-4 fixed space-y-2' onSubmit={submitHandler}>
                <button onClick={()=>setEditingForm(false)} className='absolute top-0 right-0 p-2'>
                ...
                <div className="grid grid-cols-3">
                    <input name={'name'} placeholder={'社區名稱'} type="text" className='focus:ring-2 rounded  p-2 m-1.5'
                           required={true} defaultValue={nowEdit.name}/>
                    <input name={'size'} placeholder={'大小：坪'} type='number' className='focus:ring-2 rounded  p-2 m-1.5'
                           required={true} defaultValue={nowEdit.size}/>
                    <input name={'prize'} placeholder={'價格：元'} type="number" className='focus:ring-2 rounded  p-2 m-1.5'
                           required={true} defaultValue={nowEdit.prize}/>
                </div>
                <select name="roomType" id="roomType" className='m-1.5 focus:ring-2 rounded p-2' defaultValue={nowEdit.roomType}>
                ...
                <div className="grid grid-cols-2">
                    <input name={'electric'} placeholder={'電費，可輸入文字說明'} type="text" className='focus:ring-2 rounded p-2 m-1.5'
                           required={true} defaultValue={nowEdit.electric}/>
                    <input name={'water'} placeholder={'水費，可輸入文字說明'} type="text" className='focus:ring-2 rounded p-2 m-1.5'
                           required={true} defaultValue={nowEdit.water} />
                </div>

                <input name={'address'} placeholder={'地址，選填'} type="text" className='focus:ring-2 rounded  p-2 m-1.5' defaultValue={nowEdit.address}/>
                ...
                <div className='grid grid-cols-4 m-1.5'>
                    <div>
                        ...
                        <input name={'security'} id={'security'} value="true" type="checkbox"
                               className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.security}/>
                    </div>
                    <div>
                        ...
                        <input name={'refrigerator'} id={'refrigerator'} type="checkbox" value={'true'}
                               className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.refrigerator}/>
                    </div>
                    <div>
                        ...
                        <input name={'washingMachine'} id={'washingMachine'} type="checkbox"
                               className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.washingMachine}/>
                    </div>
                    <div>
                        <label htmlFor="dryer" className='text-black dark:text-white'>烘衣機</label>
                        <input name={'dryer'} id={'dryer'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.dryer}/>
                    </div>
                    <div>
                        <label htmlFor="tv" className='text-black dark:text-white'>電視</label>
                        <input name={'tv'} id={'tv'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.tv}/>
                    </div>
                    <div>
                        <label htmlFor="AC" className='text-black dark:text-white'>冷氣</label>
                        <input name={'AC'} id={'AC'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.AC}/>
                    </div>
                    <div>
                        <label htmlFor="heater" className='text-black dark:text-white'>熱水器</label>
                        <input name={'heater'} id={'heater'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.heater}/>
                    </div>
                    <div>
                        <label htmlFor="bed" className='text-black dark:text-white'>床</label>
                        <input name={'bed'} id={'bed'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.bed}/>
                    </div>
                    <div>
                        <label htmlFor="wardrobe" className='text-black dark:text-white'>衣櫃</label>
                        <input name={'wardrobe'} id={'wardrobe'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.wardrobe}/>
                    </div>
                    <div>
                        <label htmlFor="internet" className='text-black dark:text-white'>網路</label>
                        <input name={'internet'} id={'internet'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.internet}/>
                    </div>
                    <div>
                        <label htmlFor="elevator" className='text-black dark:text-white'>電梯</label>
                        <input name={'elevator'} id={'elevator'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.elevator}/>
                    </div>
                    <div>
                        <label htmlFor="lot" className='text-black dark:text-white'>停車場</label>
                        <input name={'lot'} id={'lot'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.lot}/>
                    </div>
                    <div>
                        <label htmlFor="sofa" className='text-black dark:text-white'>沙發</label>
                        <input name={'sofa'} id={'sofa'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.sofa}/>
                    </div>
                    <div>
                        <label htmlFor="desk" className='text-black dark:text-white'>書桌</label>
                        <input name={'desk'} id={'desk'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.desk}/>
                    </div>
                    <div>
                        <label htmlFor="balcony" className='text-black dark:text-white'>陽台</label>
                        <input name={'balcony'} id={'balcony'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.balcony}/>
                    </div>
                    <div>
                        <label htmlFor="garbage" className='text-black dark:text-white'>垃圾場</label>
                        <input name={'garbage'} id={'garbage'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.garbage}/>
                    </div>
                    <div>
                        <label htmlFor="pet" className='text-black dark:text-white'>養寵物</label>
                        <input name={'pet'} id={'pet'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.pet}/>
                    </div>
                    <div>
                        <label htmlFor="cook" className='text-black dark:text-white'>開伙</label>
                        <input name={'cook'} id={'cook'} type="checkbox" className='focus:ring-2 rounded p-1' defaultChecked={nowEdit.furniture.cook}/>
                    </div>
                    {/*<div>*/}
                ...
                <textarea name="other" placeholder={'其他'}  rows="5" className='focus:ring-2 rounded p-2 m-1.5 resize-none' defaultValue={nowEdit.other}></textarea>
